...
import { config } from "./Source/api/docs/config/prefs.js";
import {
...
//app.use(express.static(join(config.__dirname, "/Source/")));
//app.use(express.static(join(config.__dirname, "/Source/config/")));
//app.use(express.static(join(config.__dirname, "/Source/public/")));
//app.use(express.static(join(config.__dirname, "/Source/Html/")));
