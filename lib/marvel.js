...
export async function returnCharactersNumber()
{
  ...
  var parameters = `ts=${timestamp}&apikey=${process.env.PUBLIC_KEY}&hash=${MD5(timestamp+process.env.PRIVATE_KEY+process.env.PUBLIC_KEY)}&`
...
*/  
  ...
  query="offset="+(global.max_characters-1500)+"&";
